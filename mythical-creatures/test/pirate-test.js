...
describe('Pirate', function() {
  ...
  it('should not be able to lift a curse if not enough booty', function() {
    var pirate = new Pirate('Scott');
    pirate.cursed = true;
    
    assert.equal(pirate.booty, 0);
    assert.equal(pirate.liftCurse(), 'Not enough booty to lift your curse!');
  })
